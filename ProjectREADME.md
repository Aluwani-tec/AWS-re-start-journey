...
- CloudQuest Compute tasks  
- Lab documentation and screenshots  

### **Storage**
- Amazon S3  
- Static website hosting  
- Permissions, bucket policies, uploads  
...
- File permissions, navigation, process management  
...
- Ability to troubleshoot and learn independently  
- Readiness for cloud support or junior cloud engineering roles  
